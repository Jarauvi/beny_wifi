...
class SERVER_MESSAGE(Enum):
    ...
    SEND_VALUES_1P = {
        ...
        "structure": {
            ...
            "timer_start_h": slice(34, 36),
            "timer_start_min": slice(36, 38),
            "timer_start_sec": slice(38, 40),
            "timer_end_h": slice(40, 42),
            "timer_end_min": slice(42, 44),
            "timer_end_sec": slice(44, 46),
    ...
    SEND_VALUES_3P = {
        ...
        "structure": {
            ...
            "timer_start_sec": slice(48, 50),
            "timer_end_h": slice(50, 52),
            "timer_end_min": slice(52, 54),
            "timer_end_sec": slice(54, 56),
